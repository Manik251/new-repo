...
# change=data.replace('Veg', 'Nonveg')
# print(change)


# user_email="manikshrestha321@gmail.com"
# hero = user_email.split('@')
# print(hero)
# hero1 = user_email.split('.')
# print(hero1)

#strip ()
data10 = "                    Welcome to Nepal"
print(data10)
without_space_data = data10.strip()
print(without_space_data)
